...
export type InsertLocalAssets = {
    assetPaths: string[];
    isUpload: boolean;
    id: string;
}

export async function insertLocalAssets(assetsDirPath: string[], isUpload = true, id: string): Promise<InsertLocalAssets> {
    let data = {
        assetPaths: assetsDirPath,
        isUpload: isUpload,
        id: id
    };
...
export type ResgGetBlockDOM = {
    id: BlockId;
    dom: string;
}

export async function getBlockDOM(id: BlockId): Promise<ResgGetBlockDOM> {
    let data = {
        id: id
    }
...
export type ResCheckBlockExist = {
    result: boolean
}

export async function checkBlockExist(id: BlockId): Promise<ResCheckBlockExist> {
    let data = {
        id: id
    }
    let url = '/api/block/checkBlockExist';
    return request(url, data);
}
...
export async function getWorkspaces(): Promise<GetWorkspaces[]> {
